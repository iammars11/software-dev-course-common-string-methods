...
let extractedBootcamp = inputString.trim().slice(15, 23);
...
// Results of the above input
// trimmedString: 'Welcome to the Coding Bootcamp! Learn JavaScript today.',
  // replacedString: '  Welcome to the Coding Bootcamp! Learn JavaScript today.  ',
  wordsArray: [
    //'Welcome',
    // 'to',
    //'the',
